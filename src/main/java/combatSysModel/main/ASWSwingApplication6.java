...
import asw.soa.main.ASWModel5;
import asw.soa.main.ASWSwingApplication5;
...
public class ASWSwingApplication6 extends DSOLApplication {
     ...
     */
    public ASWSwingApplication6(final String title, final DSOLPanel<Double, Double, SimTimeDouble> panel) {
        super(title, panel);
    }
    ...
    public static void main(final String[] args) throws SimRuntimeException, RemoteException, NamingException {
        ...
        ASWModel6 model = new ASWModel6(simulator);
        ...
        new ASWSwingApplication6("Anti-Submarine-Warfare v0.6", panel);
    }
