...
public class ASWSwingApplication7 extends DSOLApplication {
     ...
     */
    public ASWSwingApplication7(final String title, final DSOLPanel<Double, Double, SimTimeDouble> panel) {
        super(title, panel);
    }
    ...
    public static void main(final String[] args) throws SimRuntimeException, RemoteException, NamingException {
        ...
        AntiTorpedoCombatModel model = new AntiTorpedoCombatModel(simulator);
        ...
        new ASWSwingApplication7("Anti-Submarine-Warfare v0.7", panel);
    }
