...
public class ASWSwingApplication8 extends DSOLApplication {
     ...
     */
    public ASWSwingApplication8(final String title, final DSOLPanel<Double, Double, SimTimeDouble> panel) {
        super(title, panel);
    }
    ...
    public static void main(final String[] args) throws SimRuntimeException, RemoteException, NamingException {
        ...
        CombatModel model = new CombatModel(simulator);
        ...
        new ASWSwingApplication8("Anti-Submarine-Warfare v0.8", panel);
    }
